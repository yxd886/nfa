...
--input_port="rt1_iport" --output_port="rt1_oport" --control_port="rt1_cport" --worker_core=1 --service_chain="${service_chain}" --deduplicate_target_flag=true > /home/net/nfa/eval/deduplication_test/rt1_log.log 2>&1 &
fi
