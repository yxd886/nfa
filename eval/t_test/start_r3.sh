...
if ["$0" -ge "1"]
then
sudo nohup ~/nfa/runtime/samples/real_rpc_basic/server_main --runtime_id=4 --input_port_mac="52:54:03:01:00:01" \
...
if ["$0" -ge "2"]
then
sudo nohup ~/nfa/runtime/samples/real_rpc_basic/server_main --runtime_id=5 --input_port_mac="52:54:03:02:00:01" \
...
if ["$0" -ge "3"]
then
sudo nohup ~/nfa/runtime/samples/real_rpc_basic/server_main --runtime_id=6 --input_port_mac="52:54:03:03:00:01" \
