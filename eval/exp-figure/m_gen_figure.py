...
def draw(numbers):
	...
	x = np.arange(5)
	width = 0.25
	ax1.plot(x,n,'D',color='b', linewidth=3, markersize=10)
	ax1.errorbar(x, n, fmt=':',color='b', yerr=eb, linewidth=3)
	plt.xticks(x, labels)
	ax1.set_xlabel("# of migrated flows per runtime", fontsize=25, style='normal', color='black')
	ax1.set_ylabel("Time (ms)", fontsize=25, style='normal', color='black')
	...
	plt.savefig("Migration.pdf", bbox_inches='tight', pad_inches=0)
	plt.show()
