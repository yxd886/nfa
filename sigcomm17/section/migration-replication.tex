...
Since the coordinator is a single-threaded module that mainly maintains composition of clusters in the system, we can persistently log and replicate such information into a reliable storage system such as ZooKeeper\cite{hunt2010zookeeper}. %\chuan{where do you replicate the information to?}.
...
%\chuan{update the following paragraph on how virtual switch is to be replicated}
